...
EXTENSIONS["GG"]="bin sms gg zip 7z"
EXTENSIONS["GW"]="mgw zip 7z"
EXTENSIONS["INTELL"]="zip int bin rom 7z"
EXTENSIONS["JAVA"]="jar"
EXTENSIONS["LOWRES"]="nx zip 7z"
EXTENSIONS["LYNX"]="lnx lyx o zip 7z"
EXTENSIONS["MAME"]="zip 7z"
EXTENSIONS["MD"]="bin gen smd md 32x cue iso chd sms gg sg sc m3u 68k sgd pco zip 7z"
EXTENSIONS["MDSU"]="bin gen smd md 32x iso chd sms gg sg sc m3u 68k sgd pco zip 7z"
...
EXTENSIONS["NDS"]="nds ids dsi 7z zip"
...
EXTENSIONS["SGB"]="gb gbc dmg zip 7z"
...
EXTENSIONS["VECTREX"]="bin vec zip 7z"
EXTENSIONS["WOLF3D"]="ecwolf pk3 squashfs"
EXTENSIONS["WS"]="ws wsc pc2 pcv2 zip 7z"
EXTENSIONS["X68000"]="dim img d88 88d hdm dup 2hd xdf hdf cmd m3u zip 7z"
EXTENSIONS["ZX"]="tzx tap z80 rzx scl trd dsk dck sna szx zip 7z"
